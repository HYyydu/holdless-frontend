        ...
        <div className="flex items-center justify-between">
          ...
          >
            <img
              ...
              src="/lovable-uploads/e1e7522b-4147-4d9f-bbb5-1b04bc489348.png"
            />
      ...
      <main className="relative z-10 container max-w-7xl mx-auto px-4 pt-20 pb-32">
        <div className="text-center space-y-12">
          <div className="space-y-8 max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight [word-spacing:0.2em]">
              <span className="text-foreground">Stop Fighting </span>
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
              Holdless calls insurers, provider billing offices, and doctor's
              offices for patients to resolve medical bills, denied claims, and
              ...
              <div className="space-y-5">
                ...
                <div className="bg-muted/50 rounded-xl p-5 border-l-4 border-primary">
                  <p className="text-sm md:text-base text-foreground leading-relaxed">
                    "Hi, I'm calling as Maria's authorized assistant regarding a
                    prior authorization issue for a medical procedure. We need
                    help confirming what documentation is missing and how to
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-card rounded-2xl p-8 shadow-sm border border-border/40">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                  Tell us what you need help with in plain English. Whether it's
                  a refund request, account issue, or product inquiry, just
